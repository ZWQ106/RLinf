...
desk "cd $TASL && ulimit -n 8192 && LC_ALL=C.UTF-8 PYTHONPATH=$TASL:$SITE_PKGS:$DESKTOP_HOME/work/openpi/packages/openpi-client/src setsid /usr/bin/python3 dashboards/openpi.py --port 8003 --policy-host 127.0.0.1 --policy-port 8000 $WRIST_FLAG </dev/null >> $TASL/logs/openpi.log 2>&1 &"
